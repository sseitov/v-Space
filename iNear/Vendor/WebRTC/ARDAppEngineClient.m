                                     ...
                                     NSError *error))completionHandler
{
    ...
    if (isLoopback) {
        urlString =
        [NSString stringWithFormat:kARDRoomServerJoinFormatLoopback, _serverHostUrl, roomId];
    } else {
        urlString =
        [NSString stringWithFormat:kARDRoomServerJoinFormat, _serverHostUrl, roomId];
    }
    ...
    [[PostRequester shared] sendAsyncRequest:request
                                ...
                                NSError *error))completionHandler
{
    ...
    [NSString stringWithFormat:
     kARDRoomServerMessageFormat, _serverHostUrl, roomId, clientId];
          ...
          completionHandler:(void (^)(NSError *error))completionHandler
{
    ...
    NSString *urlString =
    [NSString stringWithFormat:kARDRoomServerLeaveFormat, _serverHostUrl, roomId, clientId];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url];
    request.HTTPMethod = @"POST";
